...
export function meta(bead: GcWorkflowBead | undefined, key: string): string | undefined {
...
export function normalizedStepRef(bead: GcWorkflowBead): string | null {
  const ref =
...
export function iterationFor(bead: GcWorkflowBead): number | undefined {
  return (
...
export function attemptFor(bead: GcWorkflowBead): number | undefined {
  return (
